...
class TambahScheduleEdgblok3Activity : AppCompatActivity(), AnkoLogger {
    ...
    lateinit var binding : ActivityTambahScheduleEdgblok3Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this,R.layout.activity_tambah_schedule_edgblok3)
        ...
        binding.btntambah.setOnClickListener {
            ...
            if (tw.isNotEmpty() && hari!=null  && tahun.isNotEmpty()){
                loading(true)
                api.schedule_edgblok3(hari!!, tw, tahun).enqueue(object :
