...
import com.sipmat.sipmat.databinding.ActivityTambahScheduleSeaWaterBinding
...
class TambahScheduleSeaWaterActivity : AppCompatActivity(), AnkoLogger {
    var tanggal_cek : String? = null
    lateinit var progressDialog: ProgressDialog
    var api = ApiClient.instance()
    var lokasi_seawater : String? = null
    var id_seawater : Int? = null
    var hari : String? = null

    lateinit var binding : ActivityTambahScheduleSeaWaterBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this,R.layout.activity_tambah_schedule_sea_water)
        ...
        binding.btntambah.setOnClickListener {
            ...
            if (tw.isNotEmpty() && hari!=null  && tahun.isNotEmpty()){
                var body = PostSeaWaterSchedule(hari,tw,tahun)
                loading(true)
                api.schedule_seawater(body).enqueue(object :
    ...
    fun spnhari(){
        ...
        val spinner = find<Spinner>(R.id.spn_seawater)
        if (spinner!=null){
