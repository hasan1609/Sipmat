...
import com.sipmat.sipmat.databinding.ActivityTambahScheduleEdgblok1Binding
import com.sipmat.sipmat.databinding.ActivityTambahScheduleEdgblok2Binding
import com.sipmat.sipmat.databinding.ActivityTambahScheduleFfblokBinding
...
class TambahScheduleEdgblok2Activity : AppCompatActivity(), AnkoLogger {
    ...
    lateinit var binding : ActivityTambahScheduleEdgblok2Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this,R.layout.activity_tambah_schedule_edgblok2)
        ...
        binding.btntambah.setOnClickListener {
            ...
            if (tw.isNotEmpty() && hari!=null  && tahun.isNotEmpty()){
                loading(true)
                api.schedule_edgblok2(hari!!, tw, tahun).enqueue(object :
