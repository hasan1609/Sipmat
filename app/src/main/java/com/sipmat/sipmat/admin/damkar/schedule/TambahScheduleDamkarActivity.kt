...
class TambahScheduleDamkarActivity : AppCompatActivity(), AnkoLogger {
    ...
    lateinit var binding : ActivityTambahScheduleDamkarBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this,R.layout.activity_tambah_schedule_damkar)
        ...
        binding.btntambah.setOnClickListener {
            ...
            if (tw.isNotEmpty() && hari!=null  && tahun.isNotEmpty()){
                loading(true)
                api.schedule_damkar(hari!!, tw, tahun).enqueue(object :
