...
import com.sipmat.sipmat.databinding.ActivityTambahScheduleFfblok2Binding
...
class TambahScheduleFFblok2Activity : AppCompatActivity(), AnkoLogger {
    ...
    lateinit var binding : ActivityTambahScheduleFfblok2Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this,R.layout.activity_tambah_schedule_ffblok2)
