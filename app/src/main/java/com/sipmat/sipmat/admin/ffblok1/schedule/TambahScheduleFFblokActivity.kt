...
class TambahScheduleFFblokActivity : AppCompatActivity(), AnkoLogger {
    ...
    lateinit var binding : ActivityTambahScheduleFfblokBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this,R.layout.activity_tambah_schedule_ffblok)
        ...
        binding.btntambah.setOnClickListener {
            ...
            if (tw.isNotEmpty() && hari!=null  && tahun.isNotEmpty()){
                loading(true)
                api.schedule_ffblok(hari!!, tw, tahun).enqueue(object :
