...
class HasilFFblokAdapter(
    private val notesList: MutableList<FFBlokModel>,
    private val context: Context,

    ) : RecyclerView.Adapter<HasilFFblokAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_ffblok_pelaksana, parent, false)
