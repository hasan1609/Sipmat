...
class FFblok2PelaksanaAdapter(
    private val notesList: MutableList<FFBlok2Model>,
    private val context: Context,

    ) : RecyclerView.Adapter<FFblok2PelaksanaAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_scheduleffblok2, parent, false)
