package com.sipmat.sipmat.adapter.ffblok
...
class FFblokPelaksanaAdapter(
    private val notesList: MutableList<FFBlokModel>,
    private val context: Context,

    ) : RecyclerView.Adapter<FFblokPelaksanaAdapter.ViewHolder>() {
    ...
    interface Dialog {
        fun onClick(position: Int, note : FFBlokModel)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_scheduleffblok, parent, false)
