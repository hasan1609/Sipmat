...
class SchedulePencahayaanAdapter(
    private val notesList: MutableList<SchedulePencahayaanModel>

    ) : RecyclerView.Adapter<SchedulePencahayaanAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_schedulepencahayaan, parent, false)
