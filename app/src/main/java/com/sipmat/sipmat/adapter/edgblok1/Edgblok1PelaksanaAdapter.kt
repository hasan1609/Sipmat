...
class Edgblok1PelaksanaAdapter(
    private val notesList: MutableList<EdgBlokModel>,
    private val context: Context,

    ) : RecyclerView.Adapter<Edgblok1PelaksanaAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_scheduleedgblok, parent, false)
