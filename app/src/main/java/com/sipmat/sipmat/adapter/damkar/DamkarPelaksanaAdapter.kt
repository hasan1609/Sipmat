...
class DamkarPelaksanaAdapter(
    private val notesList: MutableList<DamkarModel>,
    private val context: Context,

    ) : RecyclerView.Adapter<DamkarPelaksanaAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_scheduledamkar, parent, false)
