...
class PencahayaanPelaksanaAdapter(
    private val notesList: MutableList<SchedulePencahayaanModel>,
    private val context: Context,

    ) : RecyclerView.Adapter<PencahayaanPelaksanaAdapter.ViewHolder>() {
    ...
    interface Dialog {
        fun onClick(position: Int, note : SchedulePencahayaanModel)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_pencahayaan_pelaksana, parent, false)
